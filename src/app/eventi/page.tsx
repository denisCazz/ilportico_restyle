...
export const metadata: Metadata = {
  title: "Eventi — Bar Il Portico Carmagnola",
  description: "Serate con musica live, dj set e aperitivi speciali al Bar Il Portico di Carmagnola.",
};
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-14 w-full">
          ...
          <p className="mt-4 text-neutral-400 text-sm max-w-md leading-relaxed">
            Serate con musica live, dj set e aperitivi speciali.<br />
            Segui il calendario per non perderti nulla.
          </p>
        </div>
      </section>
